...
| `USE_OPENBOX`      | `false`         | Start the Openbox window manager. This may be necessary if websites open unscrollable pop-up windows that need to be resized (e.g., ‘Login with Google’).                                                                                                                                                |
